    ...
    */
    ...
    private function createResource(Request $request, $resourceable) {
        $data = $request->validate([
            ...
            'document_file' => ['required_if:resource_type,new_document',
                'file',
                'sometimes',
                'mimetypes:application/pdf,application'],
            'existing_document' => ['required_if:resource_type,exisiting_document',
                'sometimes',
                'exists:documents,id'],
        ...
        case ('new_document'):
            ...
            $filepath = $document_file->store('resource_files',
                'public');
            $cover_page_data = substr($request->cover_page_data,
