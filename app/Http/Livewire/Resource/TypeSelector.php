...
class TypeSelector extends Component
{
    ...
    private function getUserDocuments() {
        ...
        $topics1 = $concepts1->pluck('topics');
        $topic_resources1 = $topics1->pluck('resources')->flatten();
        $documents_1 = $concept_resources1->merge($topic_resources1)->where('resourceful_type', Document::class)->pluck('resourceful_id');
        ...
        $topics2 = $concepts2->pluck('topics');
        $topic_resources2 = $topics2->pluck('resources')->flatten();
        $documents_2 = $concept_resources2->merge($topic_resources2)->where('resourceful_type', Document::class)->pluck('resourceful_id');
        return  Document::whereIn('id', $documents_1->merge($documents_2))->orderBy('title', 'ASC')->get();
    }
