...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/user/spaces/{space:slug}/concept/{concept:slug}/topic/{topic:slug}/add-resource', ['App\Http\Controllers\ResourceController', 'create'])->name('resource.create');
    Route::post('/user/spaces/{space:slug}/concept/{concept:slug}/topic/{topic:slug}/store-resource', ['App\Http\Controllers\ResourceController', 'store'])->name('resource.store');
});
