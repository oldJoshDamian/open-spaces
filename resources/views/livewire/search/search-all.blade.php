<div>
    <div class="justify-end md:flex">
        <div class="relative">
            <div class="flex">
                <x-jet-input wire:model="query" type="search" name="open_search" class="w-full mr-3 bg-gray-100 md:w-96" placeholder="search Open Spaces" />
            ...
            <div class="w-full mt-4 mb-4 md:overflow-y-auto md:max-h-96 md:z-50 md:absolute md:shadow-2xl">
