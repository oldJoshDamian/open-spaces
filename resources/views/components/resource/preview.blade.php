...
<div class="bg-gray-100">
    ...
    <a class="block" href="/pdf-reader/web/viewer.html?file=/storage/{{ $resourceful->url }}@if($resourceful->specific_pages)#page={{ $resourceful->specific_pages['start_page'] }} @endif">
        ...
        <div>
            ...
            <div class="p-3 text-sm font-semibold text-blue-700 bg-white">
                ...
                <div class="pt-3 text-blue-700">
                    ...
                    <a class="underline" href="/pdf-reader/web/viewer.html?file={{ $resourceful->full_url }}#page={{ $resourceful->specific_pages['start_page'] }}">Page
                        {{ $resourceful->specific_pages['start_page'] }}</a>
                    @endif
                    @if($resourceful->specific_pages['end_page'])
                    - <a class="underline" href="/pdf-reader/web/viewer.html?file=/storage/{{ $resourceful->url }}#page={{ $resourceful->specific_pages['end_page'] }}">Page
