    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg">
                <div class="grid grid-cols-1 gap-6 px-6 lg:px-0 md:grid-cols-2">
                    ...
                    <div class="bg-white shadow-md md:rounded-md">
                        <a href="{{ route('space.show', ['space' => $space]) }}">
                            <div class="flex items-center p-4 border-b border-gray-300">
                                ...
                                <div>
                                    <div class="text-xl font-medium text-gray-800">{{ $space->name }}
                                    </div>
                                    <div class="text-sm font-medium text-gray-500">{{ $space->visibility }} space
                                    </div>
                                </div>
                            </div>
